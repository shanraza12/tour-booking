...
import { setLocalItem } from "../../helpers/storageUtils";
export default function SignInForm() {
  ...
  const { mutate, isLoading } = usePost("/auth/admin/login");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    mutate({
      ...
      onSuccess: (response) => {
        ...
        setLocalItem("user",response?.user);
        setLocalItem("token", response?.user?.token);
        navigate("/")
      },
      onError: (error) => {
