...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | SkyLiners - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for SkyLiners - React.js Tailwind CSS Admin Dashboard Template"
      />
