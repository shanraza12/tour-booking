        ...
        <Row>
          <div className="nav__wrapper d-flex align-items-center justify-content-between">
            ...
            <div className={`navigation ${isMenuOpen ? "show__menu" : ""}`} ref={menuRef} onClick={toggleMenu}>
              <ul className="menu d-flex align-items-center gap-4 m-0">
                ...
                {user && (
                    <li className="nav__item">
                      {user.role === "agency" || user.role === "admin" ? (
                        <NavLink to="/agency-dashboard" className={(navClass) => navClass.isActive ? "active__link" : ""}>
                          Dashboard
                        </NavLink>
                      ) : (
                        <NavLink to="/my-bookings" className={(navClass) => navClass.isActive ? "active__link" : ""}>
                          My Bookings
                        </NavLink>
                      )}
                    </li>
